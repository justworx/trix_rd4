...
class IRCInfo(IRCPlugin):
	...
	def handle(self, e):
		...
		#
			...
			try:
				...
				trix.log("info plugin: WHO (353) failed")
				raise
	...
	def on_join (self, e):
		if e.nick != self.bot.nick:
			try:
				...
				trix.log("info plugin: on_join fail.", e=e.dict)
	...
	def on_kick(self, e):
		...
		try:
			...
			trix.log("info plugin: on_kick fail.", e=e.dict)
	...
	def on_part(self, e):
		try:
			...
			trix.log("info plugin: on_part fail.", e=e.dict)
